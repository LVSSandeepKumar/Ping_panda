      ...
      <div className="flex flex-1 flex-col">
        ...
        <div className="h-16 bg-[#36393f] flex items-center px-4 shadow-sm border-b border-[#202225]">
          ...
          <div className="flex items-center">
            ...
            <p className="font-medium text-white">Ping Panda</p>
          </div>
        ...
        <div className="p-4">
          <div className="flex items-center bg-[#40444b] rounded-lg p-1">
            ...
            <input readOnly type="text" placeholder="Message @PingPanda" className="flex-1 bg-transparent text-white placeholder-[#72767d] focus:outline-none cursor-not-allowed"/>
